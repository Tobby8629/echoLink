  ...
  return (
    <div>
      ...
      <div className="md:flex md:justify-between">
        {teams.map((e: team)=>(
            <div key={e.name} className="h-[339px] flex flex-col max-sm:w-[85%] max-sm:h-[320px] rounded-lg mx-auto my-10 max-lg:w-[220px] max-lg:h-[280px] bg-transparent shadow-lg">
